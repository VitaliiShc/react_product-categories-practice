...
const products = productsFromServer.map(product => {
  product.category = categoriesFromServer.find(category => {
    return category.id === product.categoryId;
  });
  product.category.owner = usersFromServer.find(user => {
    return user.id === product.category.ownerId;
  });
...
export const App = () => {
  ...
  const filterProductsByUserId = userId => {
              ...
              {users.map(user => (
                <a
                  ...
                  onClick={() => {
                    ...
                    // filterProductsByUserId(user.id); ??? point before commit
                  }}
                >
                  {user.name}
                </a>
